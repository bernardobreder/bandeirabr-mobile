...
public class ProductSetWithProductDateServlet extends AuthServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      String query = getSqlStream(ProductSetWithProductDateServlet.class);
      ...
      while (rs.next()) {
        ...
        writer.writeString("child_id", rs.getString("child_id"));
        writer.end();
      }
      rs.close();
      ps.close();
