...
public class ProductSetWithProductSetDateServlet extends AuthServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      String query = getSqlStream(ProductSetWithProductSetDateServlet.class);
      ...
      while (rs.next()) {
        ...
        writer.writeInt("child_id", rs.getInt("child_id"));
        writer.end();
      }
      rs.close();
      ps.close();
