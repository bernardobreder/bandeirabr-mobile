...
public class ProductSetWithProductListServlet extends AuthServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp)
    ...
    try {
      ...
      String query = getSqlStream(ProductSetWithProductListServlet.class);
      ...
      while (rs.next()) {
        ...
        writer.writeString("child_id", rs.getString("child_id")).next();
